...
export default function TransactionHistory() {
  const { eoaAddress, loading: addressLoading, error: addressError } = useEOAAddress();
  ...
  useEffect(() => {
    ...
    const fetchTransactionHistory = async () => {
      try {
        ...
        const response = await fetch(`/api/get-transaction-history?eoaAddress=${eoaAddress}`);
  ...
  const getTokenInfo = (tokenAddress) => {
    ...
    return token || { name: truncateAddress(tokenAddress), logoURI: null, decimals: 18 };
  };
          ...
          {transactions.map((transaction) => {
            ...
            return (
              ...
              >
                ...
                <td className="py-3 pr-4 text-white/80 font-mono text-sm">
                ...
                <td className="py-3 pr-4">
                  {transaction.txHash ? (
                    <a
                      ...
                      className="text-orange-500 hover:text-orange-400 text-sm font-mono"
                    >
