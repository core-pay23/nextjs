  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 40 40"><path fill="rgba(255,255,255,0.08)" d="M0 39h40v1H0zM39 0h1v40h-1z"/></svg>\')',
        }}
      />
    </div>
  );
...
function GlassCard({ className = "", children }) {
  return (
    <div
      className={`rounded-2xl border border-white/10 bg-slate-900/40 backdrop-blur-xl shadow-2xl shadow-black/20 ${className}`}
    >
      {children}
    </div>
  );
    ...
    <main className="relative min-h-screen text-white">
      ...
      <header className="sticky top-0 z-20 border-b border-white/10 bg-slate-900/40 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-6">
          <Link href="#" className="group flex items-center gap-3 w-14 h-14">
            <Image
              src="/icon.png"
              alt="CorePay Logo"
              width={924}
      ...
      <section className="relative">
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24 lg:py-28">
          ...
          >
            ...
            <motion.p
              variants={item}
              className="mt-5 text-pretty text-white/70"
            >
              Accept BTC, USDT, and CORE with ultra‑low fees (0.5% + gas) and
              instant settlement straight to your wallet. CorePay bridges Web2
              checkouts to the Web3 economy.
            </motion.p>
            <motion.div
              variants={item}
              className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row"
            >
              <PrimaryButton href="/dashboard" showIcon={false}>
                Apps
              </PrimaryButton>
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-16">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
              Built for merchants & developers
            </h2>
            <p className="mt-3 text-white/70">
              A simple checkout for shoppers, powerful APIs and a real‑time
              dashboard for teams.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <GlassCard className="p-6">
              ...
              <p className="mt-3 text-sm text-white/70">
                Designed to abstract blockchain complexity while keeping you
                fully in control.
              </p>
            </GlassCard>
          </div>
            ...
            <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-white/70">
                  WooCommerce plugin in progress, with Shopify and Magento on
                  the roadmap. Bring crypto to your existing storefront—no
      ...
      <section id="roadmap" className="relative">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-16">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-white/70">
              Concrete milestones as we expand CorePay across the Core DAO
          ...
          <GlassCard className="p-8 text-center">
            <div className="mx-auto max-w-2xl">
              <h3 className="text-2xl font-semibold">
                Bring crypto to your checkout today
              </h3>
              <p className="mt-2 text-white/70">
                Sign up for the beta to receive API keys, sandbox access, and
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 md:px-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-white/60">
              © {new Date().getFullYear()} CorePay. All rights reserved.
            </p>
